...
copyright = u'2016 - 2021 Andr\xe9 Malo'
...
.. |pyliblinear| replace:: :product:`pyliblinear`
...
htmlhelp_basename = 'pyliblineardoc'
...
latex_documents = [
  ('index', 'pyliblinear.tex', u'pyliblinear Documentation',
