...
{
	double a_value = (*(const feature_node *)a).value;
	double b_value = (*(const feature_node *)b).value;
	int a_index = (*(const feature_node *)a).index;
	int b_index = (*(const feature_node *)b).index;
