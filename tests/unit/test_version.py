...
================================
 Tests for pyliblinear._version
================================
...
def test_repr():
    ...
    assert_equals(
        repr(ver),
        "pyliblinear._version.Version('1.2.3.4.foo', is_dev=True, revision=5)"
    )

    ver = _version.Version("1.2.3.4.foo", False, 5)
    assert_equals(
        repr(ver),
        "pyliblinear._version.Version('1.2.3.4.foo', is_dev=False, "
        "revision=5)"
    )
    ...
    assert_equals(
        repr(ver),
        "pyliblinear._version.Version('1.2.3.4.foo\\xe9', is_dev=True, "
        "revision=5)"
    )
